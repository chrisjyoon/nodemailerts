...
router.get('/', (req, res) => {
  res.send(
    `
    <h3>Welcom to mailer service using Express + Typescript Demo</h3>
    ...
    <form action="/email/" method="post">
      <div style="display: flex;flex-direction: column">
        <div style="display: flex;justify-content: end">
          ...
          <input id="email" type="email" name="to" style="width:200px"><br>
        </div>
        <div style="display: flex;justify-content: end">
          <label for="subject" style="width:100px">Subject: </label>
          <input id="subject" type="text" name="subject" value="node express mailer test" style="width:200px">
        </div>
      </div>
      <p></p>
